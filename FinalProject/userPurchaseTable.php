...
<title>My Purchase History · BookMarked</title>
...
<style>
  ...
  .pt-table a:hover { color: var(--teal-800); }
...
<main class="pt-content">
  ...
  <div class="pt-header-row">
    <h1 class="pt-title"><span class="spark">&#10022;</span> My Purchase History</h1>
      ...
      <tbody>
        <?php if ($num_rows > 0): ?>
          <?php while ($row = mysqli_fetch_assoc($purchased_result)): ?>
            <tr>
              ...
              <td><a href="sellershop.php?seller_id=<?php echo urlencode($row['seller_id']); ?>"><?php echo htmlspecialchars($row['seller_name']); ?></a></td>
        ...
        <?php else: ?>
          <tr class="pt-empty-row">
            <td colspan="5">You haven&rsquo;t purchased any books yet.</td>
          </tr>
        <?php endif; ?>
      </tbody>
    </table>
